...
const Webpage = () => {
  ...
  if (networkCheck === 421613 && account !== undefined) {
    // change to 42161 for production
    return (
      <div className="centered">
        <div>
          ...
          <p>
            <b>
              Try the <a href="https://arbilocker.herokuapp.com">Mainnet</a>
            </b>
          </p>
          <br />
    ...
    return (
      <div className="centered">
        <p>
          Please connect your Metamask account. You must be connected to the
          Arbitrum Testnet.
        </p>
      </div>
    );
